...
const Cards = () => {
  return (
    <div className='w-[300px] h-[200px] bg-[#0b1e38] text-white p-4 flex flex-col justify-around items-center rounded-xl shadow hover:scale-105 transition-all duration-300'>
